...
public class GenericTariff implements Serializable {
    ...
    */
    ...
    public GenericTariff(Long tariffId, Double signupFee, Double baseFee, Double[] powerConsumptionPriceList, Double[] powerProductionPriceList, LocalDateTime contractStartDate, LocalDateTime contractEndDate, Integer minimumContractRuntime, Integer maximumContractRuntime, Double powerConsumptionThreshold, Double powerConsumptionSurcharge, Double powerProductionThreshold, Double powerProductionSurcharge) {
        ...
        this.signupFee = this.signupFee.setScale(Constants.DECIMALS, Constants.ROUNDING_MODE);

        this.baseFee = new BigDecimal(baseFee.toString());
        this.baseFee = this.baseFee.setScale(Constants.DECIMALS, Constants.ROUNDING_MODE);
        ...
        this.powerConsumptionThreshold = this.powerConsumptionThreshold.setScale(Constants.DECIMALS, Constants.ROUNDING_MODE);

        this.powerConsumptionSurcharge = new BigDecimal(powerConsumptionSurcharge.toString());
        this.powerConsumptionSurcharge = this.powerConsumptionSurcharge.setScale(Constants.DECIMALS, Constants.ROUNDING_MODE);

        this.powerProductionThreshold = new BigDecimal(powerProductionThreshold.toString());
        this.powerProductionThreshold = this.powerProductionThreshold.setScale(Constants.DECIMALS, Constants.ROUNDING_MODE);

        this.powerProductionSurcharge = new BigDecimal(powerProductionSurcharge.toString());
        this.powerProductionSurcharge = this.powerProductionSurcharge.setScale(Constants.DECIMALS, Constants.ROUNDING_MODE);
    }
